...
public partial class purchases : System.Web.UI.Page
{
    ...
    protected void TXT_DISACC_DRG_TextChanged(object sender, EventArgs e)
    {
        ...
        if (((TextBox)(GridView1.Rows[rindex].Cells[6].FindControl("TXT_TOTAL_PRICE_GRD"))).Text == "")
        {
            total_price_GRD = 0;
            db.ds1.Tables[0].Rows[rindex][6] = total_price_GRD;
        }
        ...
        {
            total_price_GRD = int.Parse(((TextBox)(GridView1.Rows[rindex].Cells[6].FindControl("TXT_TOTAL_PRICE_GRD"))).Text);
            db.ds1.Tables[0].Rows[rindex][6] = total_price_GRD;
        }

        if (((TextBox)(GridView1.Rows[rindex].Cells[7].FindControl("TXT_DISACC_DRG"))).Text == "")
        {
            disacc_GRD = 0;
        ...
        {
            disacc_GRD = int.Parse(((TextBox)(GridView1.Rows[rindex].Cells[7].FindControl("TXT_DISACC_DRG"))).Text);
            db.ds1.Tables[0].Rows[rindex][7] = disacc_GRD;
        }
